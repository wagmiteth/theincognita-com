...
import TableAnt from "./pages/TableAntPage";
import TableReact from "./pages/TableReactPage";
    ...
    <BrowserRouter>
      <div className="App">
        ...
        <div className="App-content">
          {" "}
          {/* To always push footer to bottom */}
          <Routes>
            ...
            <Route path="/table-ant" element={<TableAnt />} />
            <Route path="/table-react" element={<TableReact />} />
            <Route path="/apply" element={<ApplyPage />} />
            {/* New route for the Learn pages */}
            <Route
              path="/learn/how-to-establish-a-network-state"
              element={<HowToEstablishANetworkStatePage />}
            />
